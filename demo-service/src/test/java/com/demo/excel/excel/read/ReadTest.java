...
import com.example.demo.excel.read.listener.CellDataDemoHeadDataListener;
import com.example.demo.excel.read.data.CellDataReadDemoData;
import com.example.demo.excel.read.data.DemoExtraData;
import com.example.demo.excel.read.data.ExceptionDemoData;
import com.example.demo.excel.read.data.IndexOrNameData;
import com.example.demo.excel.read.listener.ConverterDataListener;
import com.example.demo.excel.read.listener.DemoExceptionListener;
import com.example.demo.excel.read.listener.DemoExtraListener;
import com.example.demo.excel.read.listener.DemoHeadDataListener;
import com.example.demo.excel.read.listener.IndexOrNameDataListener;
import com.example.demo.excel.read.listener.DemoDataListener;
import com.example.demo.excel.read.listener.NoModelDataListener;
 ...
 *
 * @author: lijiawei04
 * @date: 2021/2/26 5:09 下午
 */
@Slf4j
public class ReadTest {

    private static final String BASE_PATH = "/Users/bjhl/IdeaProjects/demo/excel/demo";
    ...
    public void simpleRead() {
        ...
        // ----- 写法1 -----
        String fileName = BASE_PATH + File.separator + "demo.xlsx";
        ...
        // ----- 写法2 -----
        fileName = BASE_PATH + File.separator + "demo.xlsx";
    ...
    public void indexOrNameRead() {
        String fileName = BASE_PATH + File.separator + "index.xlsx";
        // 这里默认读取第一个sheet
    ...
    public void converterRead() {
        String fileName = BASE_PATH + File.separator + "converter.xlsx";
    ...
    public void extraRead() {
        String fileName = BASE_PATH + File.separator + "extra.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
    ...
    public void cellDataRead() {
        String fileName = BASE_PATH + File.separator + "cellDataDemo.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
