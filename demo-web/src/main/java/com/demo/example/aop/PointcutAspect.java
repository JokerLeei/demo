...
public class PointcutAspect {
    ...
    @Pointcut(value = "within(com.demo.example.aop.AopController)")
    public void classPointcut() {}

    @Pointcut(value = "@annotation(com.demo.example.aop.AopMethodAnnotation)")
    public void annotationPointcut() {}

    @Pointcut(value = "args(java.lang.String) && execution(public * com.example.demo.aop..*.*(..))")
    public void argsPointcut() {}

    @Pointcut(value = "@args(com.demo.example.aop.AopTypeAnnotation) && execution(public * com.example.demo.aop..*.*(..))")
    public void argsAnnotationPointcut() {}

    @Pointcut(value = "target(com.demo.example.aop.AopController)")
